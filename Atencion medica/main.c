...
*
*Objetivo:
Ingresardatosde1personaeimprimirlos.
nombre[32]
edad
*
*Version:0.1del06enerode2016
*Autor:ErnestoGigliotti
*
********************************************************************/
...
int main()
{
    ...
    strcpy(listaAfiliados[3].nombre,"AA");
    strcpy(listaAfiliados[3].apellido,"SSS");
    strcpy(listaAfiliados[3].edad,"37");
    listaAfiliados[3].isEmpty=0;
    listaAfiliados[3].id=2;
...
//--------------------------------------------------------------------------------*/
    ...
    do
    {
        ...
        case '8':
            ...
            informarAfiliadosPorNombreyApellido(listaAfiliados,CANT);
            break;
        case '9':
            printf("GRAFICO EDAD.\n");
        ...
        case '0':
            if(usuarioMayorEdad(listaAfiliados,CANT,listaUsuariosMayorEdad))
            {
                for(i=0;i<CANT;i++)
                {
                    if(listaUsuariosMayorEdad[i]==-1)
                    {
                        break;
                    }
                    else
                    {
                        printf("Usuario/s de mayor edad: %s \n",listaAfiliados[(listaUsuariosMayorEdad[i])].apellido);
                    }
                }
            }
            break;
